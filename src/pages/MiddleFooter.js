...
function MiddleFooter() {
  return (
    ...
    <div className="MiddleFooter" >
     <div className="MiddleFooter_content">
        <p><b>LET'S STAY IN TOUCH</b></p>
        <span>Get updates on sales specials and more</span>
     </div>

     <div className="MiddleFooter_email">
        <div>
            <input type="email" name="email" placeholder="Enter Email Address" />
        </div>
        <span>Thanks. You're on our email list for special offers.
        </span>
     </div>
     ...
     <div className="MiddleFooter_social">
       <>{youtubeIcon}</>
       <>{twitterIcon}</>
       <>{facebookIcon}</>
       <>{instagramIcon}</>
